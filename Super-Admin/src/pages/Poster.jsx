...
export default function Poster() {
  ...
  return (
    <div className="page">
      <h1>Poster</h1>
      <p className="muted">
        Push a promotional poster to the main website. It appears as a small card in the
        top-left corner with a ✕ close button — closing it just reveals the site underneath,
        nothing else changes. Super Admin only.
      </p>
      ...
      <div className="panel" style={{ maxWidth: 560 }}>
        ...
        {imageUrl && (
          <div style={{ marginTop: 14 }}>
            ...
            <div style={{
              position: 'relative', width: 220, border: '1px solid var(--border)',
              borderRadius: 12, overflow: 'hidden', background: 'var(--surface-2)',
            }}>
              <img src={imageUrl} alt={title || 'Poster'} style={{ width: '100%', display: 'block' }} />
              <div style={{
                position: 'absolute', top: 6, right: 6, width: 22, height: 22, borderRadius: '50%',
                background: 'rgba(0,0,0,.55)', color: '#fff', display: 'grid', placeItems: 'center', fontSize: 13,
              }}>✕</div>
            </div>
          </div>
        )}
